...
class InsertTestData(object):
    ...
    def insertDept(self):
        f = open("../data/depts.txt", encoding="UTF-8")
    ...
    def insertCourses(self):
        f = open("../data/courses.txt", encoding="UTF-8")
    ...
    def insertPlans(self):
        f = open("../data/plans.txt", encoding="UTF-8")
    ...
    def insertChoices(self):
        ...
        for each in compls:
            ...
            for stu in stus:
                ...
                if sel:
                    print(" "+str(stu)+" "+str(each[0])+" "+str(each[2]))
        ...
        for choice in choices:
            ...
            if grade>60:
                try:
                    ...
                    print("[!]Error when insertGrades. "+str(e))
            else:
                ...
                try:
                    ...
                    print("[!]Error when insertGrades. "+str(e))
            print(" "+str(choice)+" "+str(grade)+" "+str(regrade))
            count += 1
        return count
...
if __name__ == "__main__":
    ...
    print("Total: ")
    print(" departments: "+str(cd))
    print(" teachers: "+str(ct))
    print(" classes: "+str(cC))
    print(" students: "+str(cs))
    print(" courses: "+str(cc))
    print(" plans: "+str(cp))
    print(" teachings: "+str(ctc))
    print(" choices: "+str(ccc))
    print(" grades: "+str(cg))
######
